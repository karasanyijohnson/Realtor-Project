    ...
    return (
        <Container fluid >
            <Row>
                    ...
                    <Container style={{ background: '#F5F5F5', height: '100%' }}>
                        ...
                        <Card style={{ alignItems: 'center', background: '#F5F5F5', border: '0px' }}>
                            <Nav defaultActiveKey="/home" className="flex-column">
                                ...
                                <Nav.Link href='/editHouse' className='activeLink'>Edit House</Nav.Link>
                ...
                <Col xs={8}>
                    <HeaderDashboard title="Edit House" />
                    <Container>
                    ...
                    <Container fluid>
                        <Card className='RightCard'>
                                ...
                                <Row>
                                    ...
                                    <Col>
                                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                            ...
                                            <Form.Control type="number" placeholder="23423" />
                                        </Form.Group>
                                    </Col>
                                    <Col>
                                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            ...
                            <Card className='addImageCard'>
                                ...
                                />
                                {/* <Button className='submitButton' type='file'>Upload Images</Button> */}
                            </Card>
                                ...
                                <Row>
                                    <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                                        ...
                                        <Form.Control as="textarea" rows={3}
                                            placeholder="This is an effort to give back to the community, by the community. Hopefully this will help you draw inspiration and serve as aresource or picking gradients for your own projects."
                                        />
                                    </Form.Group>
                                </Row>
                            </Card>
